...
export class ThemeService {
  ...
  private colors: ColorConfig[] = [
    ...
    { id: 'purpura', hex: '#a855f7', hover: '#9333ea', selected: '#a955f72f' },
    { id: 'naranja', hex: '#f97316', hover: '#ea580c', selected: '#f9741631' },
    { id: 'rojo', hex: '#ef4444', hover: '#dc2626', selected: '#ef44442d' },
  ];
